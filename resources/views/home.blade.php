...
<section class="max-w-7xl mx-auto px-6 mb-0 pt-32" aria-label="Introduction">
    <div class="flex flex-col items-center text-center max-w-4xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto" dir="rtl">
            ...
            {{-- WhatsApp CTA --}}
            <button class="group relative w-full sm:w-auto px-6 py-4 rounded-xl border font-bold transition-all flex items-center justify-center gap-3 shadow-lg overflow-hidden bg-emerald-500/10 border-emerald-500/20 text-emerald-400 hover:bg-emerald-500/20 hover:border-emerald-500/40 shadow-emerald-900/10">
                <div class="absolute inset-0 bg-gradient-to-r from-emerald-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                <svg viewBox="0 0 24 24" class="w-5 h-5 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-[10deg] fill-emerald-500" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="relative z-10">جروب الواتساب</span>
            </button>
            ...
            <a href="#features-lesen"
               class="group relative w-full sm:w-auto px-2 py-2 pl-6 rounded-xl border font-medium transition-all flex items-center gap-3 backdrop-blur-sm overflow-hidden bg-[#111216]/40 border-white/10 text-white hover:bg-[#111216]/60 hover:border-white/20">
                <div class="absolute inset-0 bg-gradient-to-r from-amber-500/10 via-orange-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                <div class="relative w-10 h-10 rounded-lg border flex items-center justify-center group-hover:scale-105 transition-transform shadow-inner ml-3 bg-gradient-to-br from-[#111216] to-black border-white/10">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 group-hover:text-amber-400 transition-colors text-white" aria-hidden="true">
                        <path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"/>
                    </svg>
                    <span class="absolute -top-1 -right-1 flex h-3 w-3">
                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-amber-400 opacity-75"></span>
                        <span class="relative inline-flex rounded-full h-3 w-3 bg-amber-500 border-2 border-[#111]"></span>
                    </span>
                </div>
                <div class="flex flex-col items-start relative z-10">
                    <span class="text-xs font-mono uppercase leading-none mb-1 text-slate-400">نظرة عامة</span>
                    <span class="text-sm font-bold group-hover:text-amber-400 transition-colors text-white">استكشف المميزات</span>
                </div>
            </a>
        </div>
